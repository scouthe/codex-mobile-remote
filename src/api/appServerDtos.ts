...
export type { ThreadGoal } from '../../documentation/app-server-schemas/typescript/v2/ThreadGoal'
export type { ThreadGoalStatus } from '../../documentation/app-server-schemas/typescript/v2/ThreadGoalStatus'
export type { ThreadGoalGetResponse } from '../../documentation/app-server-schemas/typescript/v2/ThreadGoalGetResponse'
export type { ThreadGoalSetResponse } from '../../documentation/app-server-schemas/typescript/v2/ThreadGoalSetResponse'
