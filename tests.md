...
| [Chat Composer and Message Rendering](tests/chat-composer-rendering/index.md) | 36 | Composer controls, queued messages, plan mode, markdown parsing, file links, attachments, generated images, and visible message rows. |
| [Thread Loading, Streaming, and State](tests/thread-loading-state/index.md) | 29 | Thread list/detail loading, pagination, selected-thread stability, streaming scroll behavior, live-state reads, and missing-thread handling. |
...
| [CLI, Network, and Platform](tests/cli-network-platform/index.md) | 21 | CLI startup, dev scripts, npx, Tailscale, Cloudflare tunnels, Windows, Android, Termux, and platform packaging behavior. |
| [Android Remote Shell](tests/android-remote/index.md) | 1 | Android WebView bridge, task notifications, share intake, lifecycle recovery, and shared-observer compatibility. |
...
| [Theme, Layout, and Terminal](tests/theme-layout-terminal/index.md) | 17 | Light/dark theme regressions, responsive layout, terminal UI, mobile keyboard behavior, dialog sizing, and visual alignment. |
