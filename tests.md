...
| [CLI, Network, and Platform](tests/cli-network-platform/index.md) | 20 | CLI startup, dev scripts, npx, Tailscale, Cloudflare tunnels, Windows, Android, Termux, and platform packaging behavior. |
