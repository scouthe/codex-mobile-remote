...
| [Thread Loading, Streaming, and State](tests/thread-loading-state/index.md) | 30 | Thread list/detail loading, pagination, selected-thread stability, streaming scroll behavior, live-state reads, and missing-thread handling. |
